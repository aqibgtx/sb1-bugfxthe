...
interface ClientBookingStepRendererProps {
  ...
  onBookingForChange: (bookingFor: string) => void;
  calculateTotal: () => number;
}

const ClientBookingStepRenderer: React.FC<ClientBookingStepRendererProps> = ({
  currentStep,
  cars,
  customers,
  addOns,
...
export default ClientBookingStepRenderer;