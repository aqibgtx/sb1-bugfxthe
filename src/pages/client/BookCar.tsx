...
import ClientBookingStepRenderer from '../../components/booking/ClientBookingStepRenderer';
import BookingNavigation from '../../components/booking/BookingNavigation';
import EnhancedCombinedPaymentInvoiceModal from '../../components/modals/EnhancedCombinedPaymentInvoiceModal';
import { useClientBookingForm } from '../../hooks/useClientBookingForm';

const ClientBookCar: React.FC = () => {
  const {
    // State
    currentStep,
    selectedCar,
    ...
    canProceedToStep
  } = useClientBookingForm();

  const steps = [
    { number: 1, title: 'Select Car', icon: Car },
    { number: 2, title: 'Duration & Delivery', icon: User },
  ...
  return (
    ...
    >
      <BookingHeader
        title="Book a Car"
        description="Select your preferred vehicle and complete your booking with enhanced delivery options"
